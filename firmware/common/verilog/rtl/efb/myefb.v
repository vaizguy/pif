...
/* Module Version: 1.2 */
/* /usr/local/diamond/3.3_x64/ispfpga/bin/lin64/scuba -w -n myefb -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 26.6 -i2c1 -i2c1_freq 400 -i2c1_sa 1000001 -i2c1_addr 7 -tc -tc_mode FASTPWM -tc_o WAVE_GENERATOR -tc_div 1 -tc_top 65 -tc_ocr 27 -tc_ctr -ufm -ufm_ebr 510 -mem_size 1 -ufm_0 -wb -dev 1200  */
/* Sun Jul  5 04:23:06 2015 */


`timescale 1 ns / 1 ps
module myefb (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, wb_adr_i, 
    ...
    defparam EFBInst_0.TC_OCR_SET = 27 ;
    defparam EFBInst_0.TC_TOP_SET = 65 ;
    ...
    defparam EFBInst_0.EFB_WB_CLK_FREQ = "26.6" ;
