...
/* Module Version: 1.2 */
/* /usr/local/diamond/3.3_x64/ispfpga/bin/lin64/scuba -w -n myefb -lang verilog -synth synplify -bus_exp 7 -bb -type efb -arch xo2c00 -freq 26.6 -i2c1 -i2c1_freq 100 -i2c1_sa 1000001 -i2c1_addr 7 -wb -dev 1200  */
/* Sun Jan  4 18:31:53 2015 */
...
module myefb (wb_clk_i, wb_rst_i, wb_cyc_i, wb_stb_i, wb_we_i, wb_adr_i, 
    ...
    defparam EFBInst_0.I2C1_CLK_DIVIDER = 67 ;
